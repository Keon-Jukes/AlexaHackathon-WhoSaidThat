...
const LaunchRequestHandler = {
    ...
    if(userTimeZone === "error"){
        ...
        //apla
            ...
            let responseIntro = handlerInput.responseBuilder;
        ...
        return handlerInput.responseBuilder
            // .speak(speakOutput)
            .reprompt('I can give you a warm up question, take you to round one, or for help, say help me, which would you like?')
            .getResponse();
    }
};
...
const GuessAuthorHandler = {
    ...
    handle(handlerInput){
        ...
        sessionAttributes.past_quotes.push(sessionAttributes.quoteobject);
         ...
         //store current author in variable
         //empty current_author, current quote, and the two options to make space for next author
        let roname = sessionAttributes.current_author;
        const roquote = sessionAttributes.current_quote;
        const correctFirstName = sessionAttributes.correct_name;
        sessionAttributes.current_author = null;
        sessionAttributes.current_optiontwo = null;
        sessionAttributes.current_optionone = null;
        ...
        if (winner) {
            ...
            speakOutput = `<amazon:emotion name="excited" intensity="high">
                                Correct! the author is ${roname}, you have now gotten ${sessionAttributes.roundone_correct} correct, I can give you another round one quote or say stop to end this session, which would you like?
                            </amazon:emotion>
                            <break strength="medium"/>`;
        ...
        //if users gets 10 questions correct or incorrect
        if(sessionAttributes.roundone_correct === 10){
            let correctNum = sessionAttributes.roundone_correct;
            speakOutput = `<amazon:emotion name="excited" intensity="high">
                                Correct! the author is ${roname}, you have now gotten ${correctNum} correct and unlocked the new presidential round, to play say take me to the presidential round, say round one to play this round over, or say stop to end this session, which would you like?
                            </amazon:emotion>
                            <break strength="medium"/>`;
            ...
            let incorrectNum = sessionAttributes.roundone_incorrect;
             speakOutput = `<amazon:emotion name="disappointed" intensity="medium">
                                Oh no, your guess was incorrect,you have now gotten ${incorrectNum} incorrect and lost this round, you can say round one to play again or stop to end this session?
                            </amazon:emotion>
                            <break strength="medium"/>`;
            sessionAttributes.roundone_correct = 0;
            sessionAttributes.roundone_incorrect = 0;
        ...
        // if(sessionAttributes.roundone_correct === 0 || sessionAttributes.roundone_incorrect === 0 || sessionAttributes.presidential_correct === 0 || sessionAttributes.presidential_incorrect === 0){
        //         // //apla
        //   return handlerInput.responseBuilder
        //     .addDirective({
        //     type: "Alexa.Presentation.APLA.RenderDocument",
        ...
        if(sessionAttributes.presidential_correct === 10){
            let correctNum = sessionAttributes.roundone_correct;
            speakOutput = `<amazon:emotion name="excited" intensity="high">
                                Correct! the author is ${pname}, you have now gotten ${correctNum} correct and won the game, check back periodically for new rounds and new quotes to be added to this skill, you can say presidential round to replay this round or stop to end this session, which would you like?
                            </amazon:emotion>
                            <break strength="medium"/>`;
            ...
            let incorrectNum = sessionAttributes.roundone_incorrect;
             speakOutput = `<amazon:emotion name="disappointed" intensity="medium">
                                Oh no, your guess was incorrect,you have now gotten ${incorrectNum} incorrect and lost the game, you can say round one to play again or stop to end this session?
                            </amazon:emotion>
                            <break strength="medium"/>`;
            sessionAttributes.presidential_correct = 0;
            sessionAttributes.presidential_incorrect = 0;
        ...
        //store all the updated session data
        // handlerInput.attributesManager.setSessionAttributes(sessionAttributes);
        //     if(sessionAttributes.presidential_correct === 0 || sessionAttributes.presidential_incorrect === 0 || sessionAttributes.roundone_correct === 0 || sessionAttributes.roundone_incorrect === 0){
        //           // //apla
        //     return handlerInput.responseBuilder
        //     .addDirective({
        //     type: "Alexa.Presentation.APLA.RenderDocument",
